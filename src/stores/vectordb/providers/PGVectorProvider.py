...
class PGVectorProvider(VectorDBInterface):
    ...
    async def insert_one(self, collection_name: str, text: str, 
                        ...
                        record_type: str = None, document_type: str = None):
        ...
        async with self.db_client() as session:
            async with session.begin():
                for i in range(0, len(texts), batch_size):
                    ...
                    for _text, _vector, _metadata, _record_id in zip(batch_text, batch_vectors, batch_metadatas, batch_record_ids):
    ...
    async def search_by_vector(self, collection_name: str, vector: list, limit: int) -> List[RetrieveDocuments]:
