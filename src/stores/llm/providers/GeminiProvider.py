...
class GeminiProvider(LLMInterface):
    def __init__(self, api_key: str, api_url: str=None,
        ...
        self.client = genai.Client(api_key=self.api_key, api_url=self.api_url)
    ...
    def generate_text(self, prompt: str, chat_history: list[dict], max_output_tokens: int, temperature: float = None):
        ...
        response = chat.send_message(message=self.construct_prompt(prompt, GeminiEnums.USER.value))
